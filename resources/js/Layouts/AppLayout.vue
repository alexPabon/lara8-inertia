                        ...
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                ...
                                <jet-nav-link
                                    ...
                                    :active="routeActive(link.name) || routeActive(link.subNames)"
                                >
                                    {{ __(link.text) }}
                                </jet-nav-link>
                            </div>
                        ...
                        >
                          ...
                          "
                                                ...
                                                <jet-dropdown-link
                                                    ...
                                                    v-if="$page.props.jetstream.canCreateTeams && $page.props.user.privilege.privileges.create_teams"
                                                >
                                                    {{ __('Create New Team') }}
                                                </jet-dropdown-link>
            ...
            hidden: !showingNavigationDropdown,
                ...
                >
                    <div class="pt-2 pb-3 space-y-1">
                        <jet-responsive-nav-link v-for="(link, index) in navLinks"
                                                 v-bind:key="index"
                                                 :href="route(link.name)"
                                                 :active="routeActive(link.name) || routeActive(link.subNames)"
                        >
            ...
            navLinksold: [
                {
                    ...
                    active: route().current('dashboard') || route().current('dashboard.teams'),

                },
                {
                    href: '/dashboard/extensiones',
